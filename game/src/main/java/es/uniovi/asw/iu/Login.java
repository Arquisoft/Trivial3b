...
public class Login extends JFrame {
	...
	public Login() {
		...
		panel_1.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0),
				...
				null, null));
		panel_1.setBounds(23, 11, 516, 90);
		contentPane.add(panel_1);
		panel_1.setLayout(null);

		txU1 = new JTextField();
		txU1.setBounds(259, 28, 247, 20);
		panel_1.add(txU1);
		txU1.setColumns(10);

		txP1 = new JPasswordField();
		txP1.setBounds(259, 59, 247, 20);
		panel_1.add(txP1);
		txP1.setColumns(10);
		...
		lbUsuario1.setBounds(101, 31, 148, 14);
		...
		lblPassword1.setBounds(101, 62, 129, 14);
		...
		panel_2.setBounds(23, 102, 516, 86);
		contentPane.add(panel_2);

		txU2 = new JTextField();
		txU2.setColumns(10);
		txU2.setBounds(259, 24, 247, 20);
		panel_2.add(txU2);

		txP2 = new JPasswordField();
		txP2.setColumns(10);
		txP2.setBounds(259, 55, 247, 20);
		panel_2.add(txP2);

		JLabel label = new JLabel("Introduzca su usuario");
		label.setBackground(Color.WHITE);
		label.setOpaque(true);
		label.setBounds(101, 27, 148, 14);
		panel_2.add(label);
		...
		lblPasswordUsuario.setBounds(101, 58, 129, 14);
		...
		panel_3.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0),
				...
				null, new Color(0, 0, 0)));
		panel_3.setBounds(23, 199, 516, 90);
		contentPane.add(panel_3);

		txU3 = new JTextField();
		txU3.setEnabled(false);
		txU3.setColumns(10);
		txU3.setBounds(259, 28, 247, 20);
		panel_3.add(txU3);

		txP3 = new JPasswordField();
		txP3.setEnabled(false);
		txP3.setColumns(10);
		txP3.setBounds(259, 59, 247, 20);
		panel_3.add(txP3);
		...
		label_2.setBounds(100, 31, 149, 14);
		panel_3.add(label_2);
		...
		lblPasswordUsuario_1.setBounds(100, 62, 130, 14);
		...
		panel_4.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0),
				...
				null, new Color(0, 0, 0)));
		panel_4.setBounds(23, 296, 516, 90);
		contentPane.add(panel_4);

		txU4 = new JTextField();
		txU4.setEnabled(false);
		txU4.setColumns(10);
		txU4.setBounds(259, 28, 247, 20);
		panel_4.add(txU4);

		txP4 = new JPasswordField();
		txP4.setEnabled(false);
		txP4.setColumns(10);
		txP4.setBounds(259, 59, 247, 20);
		panel_4.add(txP4);
		...
		label_4.setBounds(97, 31, 152, 14);
		panel_4.add(label_4);
		...
		lblPasswordUsuario_2.setBounds(97, 62, 134, 14);
		panel_4.add(lblPasswordUsuario_2);

		JButton btSalir = new JButton("Atras");
		...
		panel_5.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0),
				...
				null, new Color(0, 0, 0)));
		panel_5.setBounds(23, 387, 516, 90);
		contentPane.add(panel_5);

		txU5 = new JTextField();
		txU5.setEnabled(false);
		txU5.setColumns(10);
		txU5.setBounds(259, 28, 247, 20);
		panel_5.add(txU5);

		txP5 = new JPasswordField();
		txP5.setEnabled(false);
		txP5.setColumns(10);
		txP5.setBounds(259, 59, 247, 20);
		panel_5.add(txP5);
		...
		label_1.setBounds(100, 31, 149, 14);
		panel_5.add(label_1);
		...
		lblPasswordUsuario_3.setBounds(100, 62, 130, 14);
		...
		panel_6.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0),
				...
				null, new Color(0, 0, 0)));
		panel_6.setBounds(23, 484, 516, 90);
		contentPane.add(panel_6);

		txU6 = new JTextField();
		txU6.setEnabled(false);
		txU6.setColumns(10);
		txU6.setBounds(259, 28, 247, 20);
		panel_6.add(txU6);

		txP6 = new JPasswordField();
		txP6.setEnabled(false);
		txP6.setColumns(10);
		txP6.setBounds(259, 59, 247, 20);
		panel_6.add(txP6);
		...
		label_5.setBounds(97, 31, 152, 14);
		panel_6.add(label_5);
		...
		lblPasswordUsuario_4.setBounds(97, 62, 134, 14);
