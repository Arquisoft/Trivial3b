...
public class Login extends JFrame {
	 ...
	 */
	public Login() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Login.class.getResource("/es/uniovi/asw/gui/imagenes/icono.jpg")));
		setResizable(false);
		setTitle("Login");
		...
		lblNewLabel.setIcon(new ImageIcon(Login.class.getResource("/es/uniovi/asw/gui/imagenes/Trivial_pursuits_colors.jpg")));
