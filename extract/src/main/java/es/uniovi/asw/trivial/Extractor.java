...
public class Extractor {
	...
	public void chooseOption(String[] args) {
		...
		if (mode.equals("extract")) {
			if (args.length < 5) {
				System.out.println("En el modo extract todos los parámetros son necesarios");
				return;
			}
	...
	public void usage() {
		...
		System.out.println("\nModos:");
		System.out.println(" - extract: Extrae las preguntas a un fichero de salida");
		System.out.println("\t - Parámetros: <entrada> <formatoentrada> <salida> <formatosalida>");
	...
	public String extract(String formatoEntrada, String entrada, String formatoSalida, String salida) {
