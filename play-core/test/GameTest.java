...
public class GameTest {
	 ...
	 */
	/*
	 * @Test public void testGameService(){ //creamos el objeto juego, con el
	 * tablero circular GameService game = new GameServiceImpl(1);
	 * 
	 * for(int i=1;i<7;i++){ assertTrue(game.addPlayer(new
	 * Player("jugador"+i,"jugador"+i))); assertEquals(i,
